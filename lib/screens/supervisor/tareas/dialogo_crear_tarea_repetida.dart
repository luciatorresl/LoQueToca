...
class DialogoCrearTareaRepetida extends StatefulWidget {
  final String alumnoId;
  final String creadaPor; // 'tutor' o 'padre'

  const DialogoCrearTareaRepetida({
    super.key,
  ...
  @override
  State<DialogoCrearTareaRepetida> createState() =>
      _DialogoCrearTareaRepetidaState();
}

class _DialogoCrearTareaRepetidaState
    extends State<DialogoCrearTareaRepetida> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Nueva tarea repetida'),
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // OPCIONES MENSUAL: elegir dia del mes
  ...
  Future<void> _guardar() async {
    ...
    try {
      await ServicioTareasRepetidas().crear(
        titulo: _titulo.text,
        hora: horaStr,
